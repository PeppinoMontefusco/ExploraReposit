...
public class FORM_02_Brochure extends setupDriver  {
	...
	public static void brochure() throws AWTException, InterruptedException{
		test=TestManager.startTest("Form_02_Request Brochure", "Request a Brochure", "Form");
		startPage.startPage();
		...
		empdata.add(new OutputLine ( ApachePoiStyles.RESULTS,List.of(email, "Form_02_Request_Brochure"),ExcelName.USERS));
	}
