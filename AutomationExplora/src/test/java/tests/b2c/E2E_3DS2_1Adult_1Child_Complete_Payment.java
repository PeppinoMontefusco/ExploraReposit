...
public class E2E_3DS2_1Adult_1Child_Complete_Payment extends setupDriver {
	
	@Test
	public static void bookingFlow1adult1Child3DS2() throws InterruptedException, AWTException {
		test=TestManager.startTest("E2E_11", "E2E 3DS2: Scenario 1 Adult 1 Child - Complete Payment","E2E");
		startPage.startPage();
		...
		VersonixMethodsB2C.searchInputAndCompile("Date", "01012014");
