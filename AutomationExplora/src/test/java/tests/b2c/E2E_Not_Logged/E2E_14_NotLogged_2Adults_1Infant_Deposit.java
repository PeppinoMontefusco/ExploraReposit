...
public class E2E_14_NotLogged_2Adults_1Infant_Deposit extends setupDriver{
	
	@Test
	public static void bookingFlow2adults1childDepositNotLogged() throws InterruptedException, AWTException, UnirestException {
		test=TestManager.startTest("E2E_14", "E2E Not Logged: Scenario 2 Adults 1 Infant - Pay Deposit","E2E");
		startPage.startPage();
		...
		WebWrapper.verifyValue(API.getAmountBooking(bookingNumber, "80"), ExternalFunction.getSumOfStringValue(API.getAmountSinglePaymentsBooking(bookingNumber), 
