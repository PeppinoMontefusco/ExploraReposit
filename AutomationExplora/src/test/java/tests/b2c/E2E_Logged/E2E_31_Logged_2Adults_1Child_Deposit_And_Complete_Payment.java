...
public class E2E_31_Logged_2Adults_1Child_Deposit_And_Complete_Payment extends setupDriver {
	
	@Test
	public static void bookingFlow2adults1ChildDepositAndCompletePaymentLogged() throws InterruptedException, AWTException, UnirestException {
		test=TestManager.startTest("E2E_31", "E2E Logged: Scenario 2 Adult and 1 Child - Deposit and Pay Total","E2E");
		startPage.startPage();
