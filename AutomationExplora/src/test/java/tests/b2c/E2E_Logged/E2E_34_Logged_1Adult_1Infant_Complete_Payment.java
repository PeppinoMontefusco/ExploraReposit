...
public class E2E_34_Logged_1Adult_1Infant_Complete_Payment extends setupDriver {
	
	@Test
	public static void bookingFlow1adultCompletePaymentLogged() throws InterruptedException, AWTException, UnirestException {
		test=TestManager.startTest("E2E_34", "E2E Logged: Scenario 1 Adult 1 Infant - Pay Total","E2E");
		ApachePoiMethods.writeCell("1 Ad - 1 Inf - Pay Total");
		startPage.startPage();
